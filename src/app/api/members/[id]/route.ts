...
export async function PUT(
  ...
  const member = await prisma.member.update({
    ...
    data: {
      ...
      bioEn: sanitizeString(body.bioEn, 2000),
      interest: sanitizeString(body.interest, 500),
      interestEn: sanitizeString(body.interestEn, 500),
      ...
      educationEn: sanitizeStringArray(body.educationEn, 500),
      awards: sanitizeStringArray(body.awards, 500),
      awardsEn: sanitizeStringArray(body.awardsEn, 500),
