                ...
                >
                  ...
                  <div className="text-center">
                    ...
                    <div className="flex justify-center gap-3 mt-3">
                      ...
                      {member.homepage && (
                        <SafeLink href={member.homepage} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-primary" title="Homepage">
                      ...
                      {member.github && (
                        <SafeLink href={member.github} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-primary" title="GitHub">
                      ...
                      {member.scholar && (
                        <SafeLink href={member.scholar} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-primary" title="Google Scholar">
                          <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
